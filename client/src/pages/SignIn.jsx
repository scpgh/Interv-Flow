        ...
        <div className="glass-panel w-full max-w-md rounded-xl p-8 md:p-10 relative z-10 flex flex-col gap-8">
          ...
          <div className="space-y-4">
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 bg-surface-container/50 hover:bg-surface-container border border-outline-variant hover:border-outline text-on-surface py-3 px-4 rounded-lg transition-all duration-200 group cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isGoogleLoading ? (
                <>
                  <div className="w-4 h-4 border-2 border-white/20 border-t-white rounded-full animate-spin" />
                  <span className="font-label-md text-label-md">Signing in with Google...</span>
                </>
              ) : (
                <>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Submit Button */}
            <button
              className="w-full bg-[#1E1B4B] hover:bg-[#1E1B4B]/80 text-[#818CF8] hover:text-[#b4c5ff] border border-[#818cf8]/20 hover:border-[#818cf8]/40 transition-all duration-200 rounded-lg py-3 px-4 flex items-center justify-center gap-2 cursor-pointer font-semibold group disabled:opacity-60 disabled:cursor-not-allowed"
              type="submit"
            ...
            >
              {isLoading ? (
                <>
                  ...
                  <span className="font-label-md text-label-md">Signing in...</span>
                </>
              ) : (
                <>
