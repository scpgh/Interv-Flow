...
export default function Billing() {
  ...
  const handleUpgrade = async (planName) => {
    alert(`Subscription plan upgrades for ${planName} are managed exclusively by Administrators. Please contact your organization administrator or recruiter to request a plan allocation.`);
  };
