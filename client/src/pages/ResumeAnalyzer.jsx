...
export default function ResumeAnalyzer() {
  ...
  return (
    <div className="bg-[#09090b] text-[#e5e1e4] min-h-screen flex flex-col relative overflow-x-hidden pt-24 font-body-md text-left">
      ...
      <main className="flex-grow flex flex-col items-center justify-start w-full max-w-container-max-width mx-auto px-margin-mobile md:px-margin-desktop py-12 md:py-20 z-10 relative">
